...
describe 'when visiting root page' do
  ...
  context 'with small or no dataset' do
    it 'displays proper error message with no data' do
      fill_in 'Weight', with: 90
      fill_in 'Height', with: 187
    ...
    it 'displays proper error message with no small dataset' do
      create(:man, height: 180, weight: 85)
      create(:man, height: 180, weight: 90)
      create(:woman, height: 160, weight: 50)
      create(:woman, height: 160, weight: 52)
